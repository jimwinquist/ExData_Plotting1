...
plot(new.range$Datetime, as.numeric(new.range$Voltage), xlab = "datetime", ylab = "Voltage", type = "l")
...
plot(new.range$Datetime, as.numeric(new.range$Global_reactive_power), 
